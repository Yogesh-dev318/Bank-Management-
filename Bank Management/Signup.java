    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            if (t6.getText().equals("")) {
                ...
                String q1 = "insert into signup values('" + name + "','" + fname + "','" + dob + "','" + gender + "','" + email + "','" + marital + "','" + address + "','" + city + "','" + pincode + "','" + state + "')";
