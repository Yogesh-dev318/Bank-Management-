...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(){
        ...
        Exitingaccount.add(r3);
        Exitingaccount.add(r4);
        ...
        String occupation[] = {"Self-Employmed","Business","Student","Retired","Others"};
...
//        }
        ...
        try{
            if(t2.getText().equals("")){
                ...
                conn c1 = new conn();
                String q1 = "insert into signup2 values('"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhar+"','"+scitizen+"','"+eaccount+"')";
